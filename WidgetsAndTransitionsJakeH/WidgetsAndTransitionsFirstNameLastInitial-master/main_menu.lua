...
function scene:show( event )
    ...
    if ( phase == "will" ) then
        ...
        function Transition_Fade( )
            composer.gotoScene( "fade Screen", transitionOptions_Fade ) -- a
        end
        ...
        local crossFadeButton = widget.newButton( 
            {
                ...
                -- Creating text on button
                label = " X Fade", -- The text labeled on the button
                labelColor = { default = { 1, 1, 1 }, over = { 1, 1, 1 } },
                font = Arial,
                fontSize = 42,
        ...
        local zoomOutInButton = widget.newButton( 
            {
                ...
                -- Creating text on button
                label = "Zoom Out Then In", -- The text labeled on the button
                labelColor = { default = { 5, 1, 1 }, over = { 1, 1, 1 } },
                font = Arial,
                fontSize = 42,
        ...
        local zoomOutInFadeButton = widget.newButton( 
            {
                ...
                -- Creating text on button
                label = "Zoom Out And Fade In ", -- The text labeled on the button
                labelColor = { default = { 1, 1, 6 }, over = { 1, 1, 1 } },
                font = Arial,
                fontSize = 42,
        ...
        local zoomInOutButton = widget.newButton( 
            {
                ...
                -- Creating text on button
                label = "Zoom In Out aha", -- The text labeled on the button
                labelColor = { default = { 6, 0, 0 }, over = { 0, 0, 0 } },
                font = Arial,
                fontSize = 42,
