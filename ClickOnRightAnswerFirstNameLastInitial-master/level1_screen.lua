...
function scene:create( event )
    ...
    wrongAnswer1TextObject = display.newText("Incorrect", display.contentWidth*.3, display.contentHeight/2, nil, 50 )
    wrongAnswer2TextObject = display.newText("Incorrect", display.contentWidth*.2, display.contentHeight/2, nil, 50 )
    ...
    correct.isVisible = false
     ...
     wrong = display.newText("Incorrect", display.contentWidth/2, display.contentHeight*1/3, nil, 50 )
     wrong:setTextColor(100/255, 47/255, 210/255)
     wrong.isVisible = false



    --create the text object that will say wrong, set the colour then hide it
